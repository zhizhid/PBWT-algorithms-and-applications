# PBWT Algorithms and Applications Developed by Degui Zhi and Collaborators

This document lists publications related to the Positional Burrows-Wheeler Transform (PBWT) and Identity-by-Descent (IBD) detection methods developed by Degui Zhi and collaborators.
...
1. **Naseri A, Liu X, Zhang S, Zhi D\*.** Ultra-fast Identity by Descent Detection in Biobank-Scale Cohorts using Positional Burrows-Wheeler Transform. *RECOMB 2017*.

2. **Naseri A, Zhi D, Zhang S.** Multi-allelic positional Burrows-Wheeler transform. *ICCABS 2018*.

3. **Naseri A, Holzhauser E, Zhi D\*, Zhang S\*.** Efficient haplotype matching between a query and a panel for genealogical search. *ISMB 2019*.

4. **Sanaullah A, Zhi D\*, Zhang S\*.** d-PBWT: Dynamic Positional Burrows-Wheeler Transform. *RECOMB 2020*.

5. **Naseri A, Yue W, Zhang S\*, Zhi D\*.** Efficient Haplotype Block Matching in Bi-Directional PBWT. *WABI 2021*.

6. **Shakya P, Naseri A, Zhi D, Zhang S.** mcPBWT: Space-efficient Multi-column PBWT Scanning Algorithm for Composite Haplotype Matching. *ICCABS 2021*.

7. **Sanaullah A, Zhi D\*, Zhang S\*.** Haplotype Threading Using the Positional Burrows-Wheeler Transform. *WABI 2022*.

8. **Sanaullah A, Zhi D\*, Zhang S\*.** Minimal Positional Substring Cover: A Haplotype Threading Alternative to Li & Stephens Model. *RECOMB 2023*.

9. **Naseri A, Yue W, Zhang S, Zhi D\*.** FastRecomb: Fast inference of genetic recombination rates in biobank scale data. *RECOMB 2023*.

10. **Sanaullah A, Zhi D, Zhang S.** An Efficient Data Structure and Algorithm for Long-Match Query in Run-Length Compressed BWT. *WABI 2025*.

11. **Tang K, Sanaullah A, Zhi D, Zhang S.** Haplotype-based Parallel PBWT for Biobank Scale Data. *ICCABS 2025*.

12. **Shakya P, Sanaullah A, Zhi D, Zhang S.** Dynamic mu-PBWT: Dynamic Run-length Compressed PBWT for Biobank Scale Data. *RECOMB 2025*.

---

## Book Chapters

1. **Wei Y, Lewis R, Naseri A, Zhang S, Zhi D.** Genealogical search using whole-genome genotype profiles. In *Responsible Genomic Data Sharing*, pp. 51-94, 2020.

---

## Selected Conference Presentations (Oral)

1. **Zhi D, Liu X, Tang K, Zhang S, Naseri A.** RaPID: An ultra-fast method for identifying IBDs in biobanks. *ASHG Platform Talk*, Houston, TX, October 2019.

2. **Wei Y, Zhang S\*, Zhi D\*.** IBD-Mix: An accurate IBD segment-based local ancestry inference method. *ASHG Platform Talk*, Los Angeles, CA, October 2022.

---

## Related Grant Support

- **NIH R01HG010086** (Zhi, Zhang) - Scalable Methods for Identity by Descent (2018-2023, renewed 2023-2027)
- **NIH R56 HG011509** (Zhi, Zhang) - Genome Informatics for Biobank-scale Data (2021-2023)
- **NIH R01 AG081398** (Chen H, Zhi) - Efficient IBD mapping for Alzheimer's Disease and related brain imaging phenotypes (2024-2029)
